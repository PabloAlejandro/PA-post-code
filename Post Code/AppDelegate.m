...
{
    [LocationTracker sharedInstance].foregroundTrackingType = LocationServiceTrackStandardUpdates;
    [LocationTracker sharedInstance].backgroundTrackingType = LocationServiceTrackNone;
}
